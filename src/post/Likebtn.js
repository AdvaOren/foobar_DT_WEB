function Likebtn({id, initLikes = 0}) {
    ...
    const addLike = () => {
        ...
        if (!isLiked) {
            ...
            isLiked = true
            btn.className = "post-btn btn like-btn active-like-btn"
        } else if (isLiked) {
            likeCount--
            likes.innerHTML = likeCount + " likes"
            isLiked = false
            btn.className = "post-btn btn like-btn"
        }
    }
    return (
        <div className="col">
            <div className="row" id={id}>{likeCount} likes</div>
            <div className="row">
                <button onClick={addLike} id={id + 'b'}
